...
| P0-011-001-004-001-001 | 编写接口定义Service接口 | 2026-06-07T22:05 | ✅ | IVoucherWordService接口(extends IServiceX<VoucherWordEntity>)+CRUD方法(create/update/delete/getById/pageList)+@Valid+@Transactional+JavaDoc完整 | (pending) |
