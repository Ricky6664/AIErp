...
| P0-005-010-002-002-001-001 | 调用字段配置API获取当前单据的字段配置列表 | 2026-06-06T08:45 | ✅ | fieldConfig API模块+类型定义:src/api/types/fieldConfig.ts(FieldConfigItem/FieldConfigQuery/FieldConfigListResponse)+src/api/modules/fieldConfig.ts(getFieldConfigList/getFieldConfigItem);vue-tsc零错误;JSDoc文档配置说明 | (待提交) |
