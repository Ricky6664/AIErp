...
| P0-003-008-004-001-002 | 编写fin_voucher_word凭证字表索引与约束 | 2026-06-03T20:00 | ✅ | db/migration/V20260604003:PK重命名pk_fin_voucher_word+部分唯一索引uk_fin_voucher_word_code(WHERE is_deleted=false)+2个租户联合索引+6个业务查询索引+回滚脚本 | — |
