...
| P0-001-008-002-001-002 | 实现注解处理器 | 2026-05-30T12:30 | ✅ | OperLog.java注解定义完整:@Target(METHOD)/@Retention(RUNTIME)/@Documented,6属性(module/action/description/saveRequestData/saveResponseData/isSaveErrorTrace)默认值正确,配合OperLogAspect使用,mvn compile通过 | (pending) |
...
|:-----:|:-----:|:----------:|:-----:|:-----:|:-----:|
| P0 | 14 | 2,147 | 143 | 2 | 6.66% |
| P1 | 15 | 1,464 | 0 | 0 | 0.0% |
| P2 | 17 | 1,105 | 0 | 0 | 0.0% |
| **合计** | **46** | **4,716** | **143** | **2** | **3.03%** |
