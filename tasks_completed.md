...
| P0-003-008-004-001-001 | 编写fin_voucher_word凭证字表CREATE TABLE语句 | 2026-06-03T19:45 | ✅ | db/migration/V20260604002:fin_voucher_word表DDL+rollback(10通用字段+3业务字段+COMMENT全覆盖) | — |
