...
| P0-004-011-001-002-002 | 后端登录接口改造 | 2026-06-04T21:50 | ✅ | 创建CaptchaVO/扩展CaptchaService添加图形验证码图片生成(BufferedImage+干扰线+噪点+Base64)/新增GET /api/auth/captcha端点/60个auth模块测试全部通过 | (待提交) |
