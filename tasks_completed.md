...
| P0-002-006-001-002-001 | 编写间距尺寸CSS变量 | 2026-05-31T18:00 | ✅ | erp-ai-web/src/styles/variables.css:追加5个间距变量(--spacing-xs/sm/md/lg/xl)+3个圆角变量(--radius-sm/md/lg)+3个阴影变量(--shadow-sm/md/lg)+html.dark暗色阴影覆盖,main.ts已引入variables.css | (pending) |
