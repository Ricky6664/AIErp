...
|:-----:|:-----:|:----------:|:-----:|:-----:|:-----:|
| P0 | 14 | 2,147 | 550 | 2 | 25.6% |
| P1 | 15 | 1,464 | 0 | 0 | 0.0% |
| P2 | 17 | 1,105 | 0 | 0 | 0.0% |
| **合计** | **46** | **4,716** | **548** | **2** | **11.6%** |
...
| P0-005-009-013-001-001 | 编写配置文件类 | 2026-06-06T07:00 | ✅ | page-base.d.ts新增ConfigPageConfig+ConfigFormFieldConfig+ConfigGroupConfig+ConfigNavItemConfig类型；PageConfig联合类型更新；vue-tsc零错误 | (待提交) |
