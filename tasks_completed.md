...
| P0-003-002-004-001-002 | 编写系统管理表索引与约束 | 2026-05-31T19:20 | ✅ | db/migration/V20260531009__task_P0_003_002_004_001_002.sql:10张系统管理表18个索引(7个部分唯一索引含WHERE is_deleted=false+11个B-Tree查询索引),全部tenant_id首列联合索引,COMMENT ON INDEX完整+docs/specs/P0_003_002_004_001_002_spec.md | TBD |
...
|:-----:|:-----:|:----------:|:-----:|:-----:|:-----:|
| P0 | 14 | 2,147 | 287 | 2 | 13.37% |
| P1 | 15 | 1,464 | 0 | 0 | 0.0% |
| P2 | 17 | 1,105 | 0 | 0 | 0.0% |
| **合计** | **46** | **4,716** | **286** | **2** | **6.06%** |
