...
| P0-002-006-004-001-001 | 编写SCSS工具类 | 2026-05-31T18:15 | ✅ | 创建_layout.scss:flex/grid/scroll/spacing/radius/shadow工具类,@each批量生成间距,import到main.ts,pnpm build通过 | (pending) |
...
|:-----:|:-----:|:----------:|:-----:|:-----:|:-----:|
| P0 | 14 | 2,147 | 268 | 2 | 12.48% |
| P1 | 15 | 1,464 | 0 | 0 | 0.0% |
| P2 | 17 | 1,105 | 0 | 0 | 0.0% |
| **合计** | **46** | **4,716** | **268** | **2** | **5.68%** |
