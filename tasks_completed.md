...
| P0-003-001-002-001-003 | 验证规范 | 2026-05-31T18:35 | ✅ | db/migration/V20260526001__verify_chema.sql:新增公共字段规范验证(§8-12)含10字段完整性/NOT NULL约束/部分唯一索引/多租户索引/COMMENT注释/Flyway验证+docs/verification/chema_verify_report.md:完整验证报告(13项全PASS) | — |
...
|:-----:|:-----:|:----------:|:-----:|:-----:|:-----:|
| P0 | 14 | 2,147 | 280 | 2 | 13.04% |
| P1 | 15 | 1,464 | 0 | 0 | 0.0% |
| P2 | 17 | 1,105 | 0 | 0 | 0.0% |
| **合计** | **46** | **4,716** | **280** | **2** | **5.94%** |
