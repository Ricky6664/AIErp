...
| P0-005-010-002-002-002-003 | 保存主表字段值 | 2026-06-06T09:15 | ✅ | useMutation组合式函数(create/update/autoDetectMode/version回调)+fieldConfig API save endpoints(createFieldConfig/updateFieldConfig)+23单测全通过+1210全量回归零失败;测试报告已产出 | (待提交) |
