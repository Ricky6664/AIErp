# P2-013-001-000-001-001 编写聚合SQL

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-013-001-000-001-001 |
| 任务名称 | 编写聚合SQL |
| 所属模块 | P2-013 |
| 优先级 | P2 |
| 任务类型 | 综合开发任务 |
...
| 调用目标 | 调用方式 | 调用时机 |
|---------|---------|---------|
| 编码引擎 | codeGenerateService.generate("sys_code_rule") | 新增时 |
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/sys/service/聚合SQLService.java | Service接口 |
| 2 | src/main/java/com/erp/sys/service/impl/聚合SQLServiceImpl.java | Service实现类 |
