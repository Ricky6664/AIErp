# P2-015-002-008-001-001 编写导出Service

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-015-002-008-001-001 |
| 任务名称 | 编写导出Service |
| 所属模块 | P2-015 |
| 优先级 | P2 |
| 任务类型 | Service服务层 |
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/i18n/service/导出Service.java | Service接口 |
| 2 | src/main/java/com/erp/i18n/service/impl/导出ServiceImpl.java | Service实现类 |
