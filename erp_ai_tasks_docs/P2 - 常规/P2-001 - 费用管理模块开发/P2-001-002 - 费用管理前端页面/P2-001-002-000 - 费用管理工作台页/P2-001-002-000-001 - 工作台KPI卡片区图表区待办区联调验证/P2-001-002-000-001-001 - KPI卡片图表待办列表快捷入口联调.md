...
- P2-001-002-000-001 工作台KPI卡片区+图表区+待办区+联调验证（父任务）
...
### 5.2 数据源
- KPI：GET /api/expense/expense/dashboard/kpi
- 图表：GET /api/expense/expense/dashboard/charts
- 待办：GET /api/workflow/todo?limit=5
## 六、交付物清单

| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/expense/workbench/index.vue | 工作台 |
| 2 | src/views/expense/workbench/components/KpiCard.vue | KPI卡片 |
