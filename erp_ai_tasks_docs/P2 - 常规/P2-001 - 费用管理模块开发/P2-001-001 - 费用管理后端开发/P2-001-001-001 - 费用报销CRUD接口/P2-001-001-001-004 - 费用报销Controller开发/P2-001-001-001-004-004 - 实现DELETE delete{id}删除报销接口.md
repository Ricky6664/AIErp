# P2-001-001-001-004-004 实现DELETE /delete/{id}删除报销接口

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-001-001-001-004-004 |
| 任务名称 | 实现DELETE /delete/{id}删除报销接口 |
| 所属模块 | P2-001 |
| 优先级 | P2 |
| 任务类型 | 综合开发任务 |
...
- P2-001-001-001-004-003 实现PUT /update修改报销接口（前序兄弟任务）
