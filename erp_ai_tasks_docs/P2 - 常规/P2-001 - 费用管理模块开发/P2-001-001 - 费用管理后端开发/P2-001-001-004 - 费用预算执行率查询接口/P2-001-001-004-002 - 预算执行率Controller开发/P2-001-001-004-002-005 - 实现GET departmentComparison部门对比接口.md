# P2-001-001-004-002-005 实现GET /departmentComparison部门对比接口

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-001-001-004-002-005 |
| 任务名称 | 实现GET /departmentComparison部门对比接口 |
| 所属模块 | P2-001 |
| 优先级 | P2 |
| 任务类型 | 综合开发任务 |
...
实现GET /departmentComparison部门对比接口：按部门汇总；返回各部门执行率+排名+同比
...
- P2-001-001-004-002-004 实现GET /trend查询执行趋势接口（前序兄弟任务）
