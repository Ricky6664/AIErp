# P2-001-001-003-001-004 编写ExpenseBudgetUpdateDTO

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-001-001-003-001-004 |
| 任务名称 | 编写ExpenseBudgetUpdateDTO |
| 所属模块 | P2-001 |
| 优先级 | P2 |
...
定义ExpenseBudgetUpdateDTO：继承CreateDTO复用校验；新增@NotNull id字段(主键)；@NotNull version字段(乐观锁)；Service层校验version一致性
...
- P2-001-001-003-001-003 编写ExpenseBudgetCreateDTO（前序兄弟任务）
...
```java
@Data
public class ExpenseBudgetUpdateDTO extends ExpenseBudgetCreateDTO {
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/expense/dto/ExpenseBudgetUpdateDTO.java | ExpenseBudget更新DTO |
