# P2-011-002-012-001-002 编写大屏数据聚合Service

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-011-002-012-001-002 |
| 任务名称 | 编写大屏数据聚合Service |
| 所属模块 | P2-011 |
| 优先级 | P2 |
| 任务类型 | Service服务层 |
...
- P2-011-002-012-001-001 编写report_screen_config表DDL+Entity/Mapper/Service/Controller（前序兄弟任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/report/service/大屏数据聚合Service.java | Service接口 |
| 2 | src/main/java/com/erp/report/service/impl/大屏数据聚合ServiceImpl.java | Service实现类 |
