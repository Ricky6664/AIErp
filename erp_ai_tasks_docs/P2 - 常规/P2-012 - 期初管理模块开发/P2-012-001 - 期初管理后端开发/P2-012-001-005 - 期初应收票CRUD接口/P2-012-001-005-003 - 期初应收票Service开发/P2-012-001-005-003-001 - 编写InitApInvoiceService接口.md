# P2-012-001-005-003-001 编写InitApInvoiceService接口

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-012-001-005-003-001 |
| 任务名称 | 编写InitApInvoiceService接口 |
| 所属模块 | P2-012 |
| 优先级 | P2 |
...
定义编写InitApInvoiceService接口：Entity/DTO/VO三类模型完整定义，字段与数据库表一一对应，校验注解完备，展示字段含字典翻译
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/init/entity/InitApInvoiceService接口Entity.java | Entity实体类 |
| 2 | src/main/java/com/erp/init/dto/InitApInvoiceService接口CreateDTO.java | DTO类 |
| 3 | src/main/java/com/erp/init/vo/InitApInvoiceService接口ListVO.java | VO类 |
