# P2-012-001-005-004-001 编写InitApInvoiceController类

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-012-001-005-004-001 |
| 任务名称 | 编写InitApInvoiceController类 |
| 所属模块 | P2-012 |
| 优先级 | P2 |
...
定义编写InitApInvoiceController类：Entity/DTO/VO三类模型完整定义，字段与数据库表一一对应，校验注解完备，展示字段含字典翻译

## 三、前置依赖

### 3.1 前置任务

- P2-012-001-005-004 期初应收票Controller开发（父任务）
...
| 2 | src/main/java/com/erp/init/dto/InitApInvoiceCreateDTO.java | DTO类 |
| 3 | src/main/java/com/erp/init/vo/InitApInvoiceListVO.java | VO类 |
