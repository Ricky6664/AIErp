# P2-012-001-007-004-008 实现POST /submit/{id}提交审核接口

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-012-001-007-004-008 |
...
实现POST /submit/{id}提交审核接口：InitController接口定义+参数校验+Service调用+响应包装+权限注解+文档注解+操作日志
...
- P2-012-001-007-004-007 实现GET /trialBalance试算平衡查询接口（前序兄弟任务）
