# P2-012-001-007-003-001 编写InitAccountBalanceService接口

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-012-001-007-003-001 |
| 任务名称 | 编写InitAccountBalanceService接口 |
| 所属模块 | P2-012 |
| 优先级 | P2 |
| 任务类型 | Service服务层 |
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/init/service/InitAccountBalanceService接口Service.java | Service接口 |
| 2 | src/main/java/com/erp/init/service/impl/InitAccountBalanceService接口ServiceImpl.java | Service实现类 |
