# P2-012-001-003-004-001 编写InitApController类

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-012-001-003-004-001 |
| 任务名称 | 编写InitApController类 |
| 所属模块 | P2-012 |
| 优先级 | P2 |
| 任务类型 | Controller接口层 |
...
实现编写InitApController类：InitController接口定义+参数校验+Service调用+响应包装+权限注解+文档注解+操作日志

## 三、前置依赖

### 3.1 前置任务

- P2-012-001-003-004 期初应付Controller开发（父任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/init/controller/InitApController.java | Controller接口实现 |
