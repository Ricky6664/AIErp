# P2-012-001-006-004-006 实现GET /detail/{id}详情查询接口

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P2-012-001-006-004-006 |
...
实现GET /detail/{id}详情查询接口：InitController接口定义+参数校验+Service调用+响应包装+权限注解+文档注解+操作日志
...
- P2-012-001-006-004-005 实现GET /page分页查询接口（前序兄弟任务）
