# P1-005-002-001-001-001 KPI卡片组件开发

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P1-005-002-001-001-001 |
| 任务名称 | KPI卡片组件开发 |
| 所属模块 | P1-005 |
| 优先级 | P1 |
| 任务类型 | 前端KPI卡片 |
...
开发SaleQuotation工作台KPI卡片组件：卡片布局(数值+标题+趋势箭头+同比环比)、数据绑定、加载骨架屏
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/sale/workbench/components/KpiCard.vue | KPI卡片组件 |
