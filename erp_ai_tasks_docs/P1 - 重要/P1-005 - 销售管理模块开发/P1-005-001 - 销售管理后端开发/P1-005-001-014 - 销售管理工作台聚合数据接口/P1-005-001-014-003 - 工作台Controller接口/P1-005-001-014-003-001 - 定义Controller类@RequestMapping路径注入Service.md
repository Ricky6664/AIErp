...
定义SaleWorkbenchController类，@RestController+@RequestMapping("/api/sale/workbench")，注入ISaleWorkbenchService，声明GET/POST/PUT/DELETE端点方法
...
- P1-005-001-014-003 工作台Controller接口（父任务）
...
```java
@RestController
@RequestMapping("/api/sale/workbench")
@RequiredArgsConstructor
@Tag(name = "SaleQuotation管理")
public class SaleWorkbenchController {
    private final ISaleWorkbenchService saleService;
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/sale/controller/SaleWorkbenchController.java | Controller类 |

## 七、验收标准

| 序号 | 检查项 | 验证方法 |
|:---:|--------|---------|
| 1 | SaleWorkbenchController的@RestController+@RequestMapping("/api/sale/workbench")正确 | 代码检查 |
