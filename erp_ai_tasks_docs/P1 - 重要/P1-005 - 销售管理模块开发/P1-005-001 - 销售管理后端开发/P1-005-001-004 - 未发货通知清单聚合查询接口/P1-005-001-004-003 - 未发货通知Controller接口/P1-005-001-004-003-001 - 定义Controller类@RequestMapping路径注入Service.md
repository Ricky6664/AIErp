...
定义SaleGenericController类，@RestController+@RequestMapping("/api/sale")，注入ISaleGenericService，声明GET/POST/PUT/DELETE端点方法
...
- P1-005-001-004-003 未发货通知Controller接口（父任务）
...
public class SaleGenericController {
    private final ISaleGenericService saleService;
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/sale/controller/SaleGenericController.java | Controller类 |

## 七、验收标准

| 序号 | 检查项 | 验证方法 |
|:---:|--------|---------|
| 1 | SaleGenericController的@RestController+@RequestMapping("/api/sale")正确 | 代码检查 |
