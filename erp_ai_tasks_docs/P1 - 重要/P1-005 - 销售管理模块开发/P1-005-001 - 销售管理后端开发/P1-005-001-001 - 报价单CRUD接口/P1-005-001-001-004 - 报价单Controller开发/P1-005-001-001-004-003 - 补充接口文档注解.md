...
为SaleQuotationController添加Swagger注解：@Tag(接口分组)、@Operation(方法描述)、@Parameter(参数描述)、@Schema(DTO/VO字段描述)
...
- P1-005-001-001-004-002 实现接口方法（前序兄弟任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/sale/controller/SaleQuotationController.java | Swagger注解 |
