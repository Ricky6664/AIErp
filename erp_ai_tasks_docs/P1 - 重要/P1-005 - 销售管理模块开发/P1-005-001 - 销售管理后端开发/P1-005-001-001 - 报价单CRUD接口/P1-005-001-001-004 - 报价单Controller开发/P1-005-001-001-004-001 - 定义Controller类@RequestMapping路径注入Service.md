...
定义SaleQuotationController类，@RestController+@RequestMapping("/api/sale/quotation")，注入ISaleQuotationService，声明GET/POST/PUT/DELETE端点方法
...
- P1-005-001-001-004 报价单Controller开发（父任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/main/java/com/erp/sale/controller/SaleQuotationController.java | Controller类 |

## 七、验收标准

| 序号 | 检查项 | 验证方法 |
|:---:|--------|---------|
| 1 | SaleQuotationController的@RestController+@RequestMapping("/api/sale/quotation")正确 | 代码检查 |
