# P1-006-002-012-002-002 明细行编辑交互

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P1-006-002-012-002-002 |
| 任务名称 | 明细行编辑交互 |
| 所属模块 | P1-006 |
| 优先级 | P1 |
| 任务类型 | 综合开发任务 |
...
实现PurchaseOrder明细行编辑交互：行内编辑激活/失焦、新增行/删除行按钮、Tab键切换编辑列、编辑状态标记
...
- P1-006-002-012-002-001 明细行vxe-table定义（前序兄弟任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/purchase/components/DetailTable.vue | 明细行编辑组件 |
