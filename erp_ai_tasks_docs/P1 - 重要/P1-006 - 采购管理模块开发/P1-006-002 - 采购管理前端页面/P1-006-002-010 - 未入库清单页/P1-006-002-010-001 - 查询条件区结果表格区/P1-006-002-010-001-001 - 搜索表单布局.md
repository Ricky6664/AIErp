# P1-006-002-010-001-001 搜索表单布局

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P1-006-002-010-001-001 |
| 任务名称 | 搜索表单布局 |
| 所属模块 | P1-006 |
| 优先级 | P1 |
| 任务类型 | 前端搜索表单 |
...
搭建PurchaseOrder列表页搜索表单布局：el-form+el-row/el-col栅格布局，包含编号/名称/日期/状态等搜索字段，支持展开收起
    ...
    <el-row :gutter="16">
      <el-col :span="6">
        <el-form-item label="编号">
          <el-input v-model="searchForm.purchaseNo" placeholder="请输入编号" clearable />
        </el-form-item>
      </el-col>
      <el-col :span="6">
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/purchase/components/SearchForm.vue | 搜索表单组件 |
