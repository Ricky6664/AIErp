# P1-006-002-008-004-002 审核流程对话框

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P1-006-002-008-004-002 |
| 任务名称 | 审核流程对话框 |
| 所属模块 | P1-006 |
| 优先级 | P1 |
| 任务类型 | 综合开发任务 |
...
实现PurchaseOrder审核流程对话框：审核意见输入、审批历史展示(时间轴)、当前节点高亮、催办按钮
...
- P1-006-002-008-004-001 审核按钮组渲染（前序兄弟任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/purchase/components/AuditDialog.vue | 审核流程对话框 |
