# P1-006-002-011-002-001 顶部操作栏布局

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P1-006-002-011-002-001 |
| 任务名称 | 顶部操作栏布局 |
| 所属模块 | P1-006 |
| 优先级 | P1 |
| 任务类型 | 综合开发任务 |
...
实现PurchaseOrder页面顶部操作栏布局：新增/编辑/删除/审核/导出等操作按钮排列，按钮禁用状态控制
...
<template>
  <div class="toolbar">
    <el-button type="primary" @click="handleAdd" v-permission="'purchase:add'">新增</el-button>
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/purchase/components/Toolbar.vue | 操作栏组件 |
