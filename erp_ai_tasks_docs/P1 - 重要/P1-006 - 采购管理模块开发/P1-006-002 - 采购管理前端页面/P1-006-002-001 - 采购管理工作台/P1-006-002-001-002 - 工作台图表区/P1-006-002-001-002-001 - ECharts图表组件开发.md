# P1-006-002-001-002-001 ECharts图表组件开发

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P1-006-002-001-002-001 |
| 任务名称 | ECharts图表组件开发 |
| 所属模块 | P1-006 |
| 优先级 | P1 |
| 任务类型 | 前端图表组件 |
...
开发PurchaseOrder工作台ECharts图表组件：图表配置(option)、数据绑定、响应式resize、加载状态、空数据提示
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | src/views/purchase/workbench/components/ChartPanel.vue | ECharts图表组件 |
