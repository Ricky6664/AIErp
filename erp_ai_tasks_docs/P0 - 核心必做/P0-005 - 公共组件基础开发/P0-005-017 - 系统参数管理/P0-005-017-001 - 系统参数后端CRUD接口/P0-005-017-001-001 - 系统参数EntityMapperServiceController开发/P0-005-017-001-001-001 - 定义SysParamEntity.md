# P0-005-017-001-001-001 定义SysParamEntity

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P0-005-017-001-001-001 |
| 任务名称 | 定义SysParamEntity |
| 所属模块 | P0-005 |
| 优先级 | P0 |
...
@TableName"sys_param"+param_group参数分组+param_code参数编码唯一+param_name参数名称+param_value参数值+param_type值类型string/number/boolean/json+sort排序+remark+@TableLogic+@Version
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | erp-system-module/src/main/java/com/erp/system/param/entity/ | Entity实体类 |
| 2 | erp-system-module/src/main/java/com/erp/system/param/dto/ | DTO数据传输对象 |
| 3 | erp-system-module/src/main/java/com/erp/system/param/vo/ | VO视图对象 |
