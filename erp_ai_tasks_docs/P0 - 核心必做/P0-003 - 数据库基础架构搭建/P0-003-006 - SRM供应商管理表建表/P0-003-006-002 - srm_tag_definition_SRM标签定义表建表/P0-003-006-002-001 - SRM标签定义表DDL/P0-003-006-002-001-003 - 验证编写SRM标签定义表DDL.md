# P0-003-006-002-001-003 验证编写SRM标签定义表DDL
...
- P0-003-006-002-001-002 编写SRM标签定义表索引与约束（前序兄弟任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | db/migration/V20260526001__task_P0_003_006_002_001_003.sql | Flyway迁移脚本 |
| 2 | docs/specs/P0_003_006_002_001_003_spec.md | 任务规范/验证文档 |
