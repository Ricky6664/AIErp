# P0-003-002-002-001-001 编写CREATE TABLE语句

## 一、任务标识

| 属性 | 值 |
|------|-----|
| 任务编号 | P0-003-002-002-001-001 |
...
- P0-003-002-002-001 编写系统核心表DDL（父任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | db/migration/V20260526001__task_P0_003_002_002_001_001.sql | Flyway迁移脚本 |
| 2 | docs/specs/P0_003_002_002_001_001_spec.md | 任务规范/验证文档 |
