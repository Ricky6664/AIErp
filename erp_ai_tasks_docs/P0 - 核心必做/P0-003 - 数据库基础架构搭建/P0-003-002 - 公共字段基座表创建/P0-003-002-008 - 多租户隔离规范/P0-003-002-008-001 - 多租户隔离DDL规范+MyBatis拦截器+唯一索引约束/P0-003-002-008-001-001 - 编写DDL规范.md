# P0-003-002-008-001-001 编写DDL规范
...
完成编写DDL规范的开发工作，编写PostgreSQL 15+ DDL/DML脚本，遵循Flyway迁移命名规范V{yyyyMMdd}{seq}__{description}.sql，确保通用字段10个完整、部分唯一索引包含WHERE is_deleted=false
...
| 2 | docs/specs/P0_003_002_008_001_001_spec.md | 规范文档 |
