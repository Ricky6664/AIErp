# P0-003-002-008-001-002 编写MyBatis-Plus TenantLineInnerInterceptor
...
完成编写MyBatis-Plus TenantLineInnerInterceptor的开发工作，编写PostgreSQL 15+ DDL/DML脚本，遵循Flyway迁移命名规范V{yyyyMMdd}{seq}__{description}.sql，确保通用字段10个完整、部分唯一索引包含WHERE is_deleted=false

## 三、前置依赖

### 3.1 前置任务

- P0-003-002-008-001 编写多租户隔离DDL规范+MyBatis拦截器+唯一约束规范（父任务）
- P0-003-002-008-001-001 编写DDL规范（前序兄弟任务）
...
### 5.1 核心功能
1. 实现编写MyBatis-Plus TenantLineInnerInterceptor的核心逻辑
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | db/migration/V20260526001__atis_related.sql | atis相关DDL/DML脚本 |
| 2 | docs/specs/P0_003_002_008_001_002_spec.md | 规范文档 |
