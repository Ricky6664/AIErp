...
完成编写精度规则的开发工作，编写PostgreSQL 15+ DDL/DML脚本，遵循Flyway迁移命名规范V{yyyyMMdd}{seq}__{description}.sql，确保通用字段10个完整、部分唯一索引包含WHERE is_deleted=false

## 三、前置依赖

### 3.1 前置任务

- P0-003-002-013-001 编写精度优先级规范+尾差处理规则+参数配置（父任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | db/migration/V20260526001__task_P0_003_002_013_001_001.sql | Flyway迁移脚本 |
| 2 | docs/specs/P0_003_002_013_001_001_spec.md | 任务规范/验证文档 |
