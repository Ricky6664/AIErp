# P0-003-005-002-001-002 编写CRM标签定义表索引与约束
...
- P0-003-005-002-001-001 编写CREATE TABLE语句（前序兄弟任务）
...
| 序号 | 文件路径 | 说明 |
|:---:|---------|------|
| 1 | db/migration/V20260526001__task_P0_003_005_002_001_002.sql | Flyway迁移脚本 |
| 2 | docs/specs/P0_003_005_002_001_002_spec.md | 任务规范/验证文档 |
...
| 序号 | 检查项 | 验证方法 |
|:---:|--------|--------|
| 1 | 主键约束pk_xxx创建成功 | information_schema.table_constraints查询 |
