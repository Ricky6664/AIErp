<template>
  <div
    class="basic-input basic-input--color"
    :class="{
...
import type {
  ErpColorPickerProps,
  ErpColorPickerEmits,
  ErpColorPickerExpose,
  ValidatorRule
} from '@/types/basic-input'

const props = withDefaults(defineProps<ErpColorPickerProps>(), {
  disabled: false,
  loading: false,
  showAlpha: false,
  size: 'default'
...
const emit = defineEmits<ErpColorPickerEmits>()
...
defineExpose<ErpColorPickerExpose>({
  validate,
  reset
})
</script>
