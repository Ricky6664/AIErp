<template>
  <div class="page-p06-master-form">
    <!-- 查询区 -->
...
import type { PageBaseProps, PageBaseEmits, MasterFormPageConfig } from '@/types/page-base.d.ts'

const props = defineProps<PageBaseProps>()

const emit = defineEmits<PageBaseEmits>()

const config = computed<MasterFormPageConfig>(() => {
  return (props.config || {}) as MasterFormPageConfig
})
