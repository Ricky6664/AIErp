    ...
    <div v-loading="loading" class="workbench-content">
      ...
      <template v-else>
        ...
        <section class="workbench-section">
          ...
          <el-row :gutter="16" class="kpi-row">
            <el-col :xs="12" :sm="8">
              <KpiCard title="待审批" :value="todoCount.pending_approval ?? 0" :loading="loading" />
            </el-col>
            <el-col :xs="12" :sm="8">
              <KpiCard title="待处理" :value="todoCount.pending_handle ?? 0" :loading="loading" />
            </el-col>
            <el-col :xs="12" :sm="8">
              <KpiCard title="待确认" :value="todoCount.pending_confirm ?? 0" :loading="loading" />
            </el-col>
          </el-row>
        </section>
